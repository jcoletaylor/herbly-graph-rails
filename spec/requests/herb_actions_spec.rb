  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates a new HerbAction' do
        ...
        end.to change(HerbAction, :count).by(1)
      end

      it 'renders a JSON response with the new herb_action' do
        post herb_actions_url, params: { herb_action: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      it 'does not create a new HerbAction' do
        ...
        end.to change(HerbAction, :count).by(0)
      end

      it 'renders a JSON response with errors for the new herb_action' do
        post herb_actions_url, params: { herb_action: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'updates the requested herb_action' do
        herb_action = HerbAction.create! valid_attributes
        patch herb_action_url(herb_action), params: { herb_action: new_attributes }, headers: valid_headers, as: :json
        herb_action.reload
