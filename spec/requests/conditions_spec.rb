  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      ...
      it 'renders a JSON response with the new condition' do
        post conditions_url, params: { condition: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      ...
      it 'renders a JSON response with errors for the new condition' do
        post conditions_url, params: { condition: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'updates the requested condition' do
        condition = Condition.create! valid_attributes
        patch condition_url(condition), params: { condition: new_attributes }, headers: valid_headers, as: :json
        condition.reload
    ...
    context 'with invalid parameters' do
      it 'renders a JSON response with errors for the condition' do
        condition = Condition.create! valid_attributes
        patch condition_url(condition), params: { condition: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
